 ...
 */
public class ProductSalePotentialCellRenderer extends JPanel implements ListCellRenderer {
	...
	public Component getListCellRendererComponent(JList list, Object value, int index,
		...
		description.setFont(new Font(CommonData.ROBOTO_LIGHT_FONT, Font.PLAIN, 15));
		...
		ImageIcon icon = createImageIcon("resources/empty11x10.png");
